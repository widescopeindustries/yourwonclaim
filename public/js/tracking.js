    ...
    function initLeadFormTracking() {
        ...
        leadForm.addEventListener('submit', async function(e) {
            ...
            try {
                ...
                // Send to /api/leads (Supabase + Resend customer welcome email)
                try {
                    ...
                    if (response.ok) {
                        console.log('Lead saved + welcome email sent');
                    } else {
                        console.warn('Lead API returned:', response.status);
                    }
                } catch (dbError) {
                    console.warn('Lead submission error:', dbError.message);
                }
